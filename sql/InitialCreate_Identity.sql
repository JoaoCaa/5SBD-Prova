...
BEGIN
    ...
    CREATE UNIQUE INDEX IX_Roles_NormalizedName ON dbo.AspNetRoles (NormalizedName) WHERE NormalizedName IS NOT NULL;
END
GO
...
BEGIN
    ...
    CREATE UNIQUE INDEX IX_Users_NormalizedUserName ON dbo.AspNetUsers (NormalizedUserName) WHERE NormalizedUserName IS NOT NULL;
    CREATE INDEX IX_Users_NormalizedEmail ON dbo.AspNetUsers (NormalizedEmail);
END
GO
